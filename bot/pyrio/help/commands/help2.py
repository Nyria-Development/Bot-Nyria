...
class CommandList2(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot

    @nextcord.slash_command(name="metrio-list-commands-2", description="List of all commands. Seconde Function",
                            force_global=True)
    async def test(self, ctx: nextcord.Interaction):
        ...
        await ctx.response.send_message(embed=help_embed, view=view)
